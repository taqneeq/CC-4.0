...
const Navbar = () => {
  return (
    <nav className="bg-[#4D4D4D] backdrop-filter backdrop-blur-lg bg-opacity-10 text-white py-1 fixed top-5 w-[90%] md:w-full max-w-7xl z-[99999] left-1/2 -translate-x-1/2 drop-shadow-[1px_1px_0_rgba(245,59,64,1)] border flex flex-row justify-between items-center ">
