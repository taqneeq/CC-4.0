...
export default function Pdomains() {
  ...
  return (
    <section
      className="h-full py-20  overflow-clip  w-full flex flex-col justify-center items-center p-8 gap-10 relative"
      id="history"
    >
      <Image
        src="/sparkle.svg"
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-1 justify-items-center max-w-7xl mx-auto">
        <motion.div
          className="md:w-[80%]"
          ref={healthcareRef}
          initial="hidden"
